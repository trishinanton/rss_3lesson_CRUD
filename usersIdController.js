...
exports.userIdController = async (req, res, personId) => {
    ...
    if (req.method === "GET") getWithPersonId(res,validate, personId)

    if (req.method === "PUT") putWithPersonId(req,res,validate, personId)

    if (req.method === "DELETE") deleteWithPersonId(res,validate, personId)
